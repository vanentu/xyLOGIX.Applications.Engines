...
{
    /// <summary>
    /// Obtains references to instances of objects that implement the <see
    ...
    public static class GetApplicationEngine
    {
        ...
        /// own layer of the application, that implements the <see
        /// cref="T:xyLOGIX.Applications.Engines.Interfaces.IApplicationEngine"/>
        /// interface and corresponds to the specified <see
        /// cref="T:xyLOGIX.Applications.Engines.Constants.EngineType"/> value.
        /// </typeparam>
        /// <param name="type">
        /// One of the <see
        /// cref="T:xyLOGIX.Applications.Engines.Constants.EngineType"/> values
        ...
        /// cref="T:xyLOGIX.Applications.Engines.Interfaces.IApplicationEngine"/> interface.
        /// </returns>
        /// <exception cref="T:System.ArgumentOutOfRangeException">
        /// Thrown if the specified <see
        /// cref="T:xyLOGIX.Applications.Engines.Constants.EngineType"/> is not supported.
        /// </exception>
        ...
        /// <summary>
        /// Determines whether the object having the type specified by <paramref
        /// name="potentialDescendantType"/> is of a class that inherits from,
        ...
        /// </param>
        /// <returns>
        /// <see langword="true"/> if the <paramref
        /// name="potentialDescendantType"/> inherits or is the <paramref
        /// name="potentialBaseType"/> ; <see langword="false"/> otherwise.
        /// </returns>
